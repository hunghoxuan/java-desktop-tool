...
import com.rs2.core.components.mempoi.datapostelaboration.mempoicolumn.StreamApiElaborationStep;
...
public class StreamApiMergedRegionsStep<T> extends StreamApiElaborationStep<T> {
    ...
    public StreamApiMergedRegionsStep(CellStyle cellStyle, int mempoiColumnIndex, SXSSFWorkbook workbook,
    ...
    private void mergeRegion(Pair<Integer, Integer> pair) {
        this.mergedRegionsManager.mergeRegion(this.sheet, this.cellStyle, pair.getLeft(), pair.getRight(),
                this.mempoiColumnIndex);
