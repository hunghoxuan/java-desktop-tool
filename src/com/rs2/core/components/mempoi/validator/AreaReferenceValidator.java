...
package com.rs2.core.components.mempoi.validator;
...
public class AreaReferenceValidator {
    ...
    // * @return
    // */
    // public boolean areAreaOverlapping(AreaReference areaRefOne, AreaReference
    // areaRefTwo) {
    //
    // String[] areaOneFirstCellRefParts =
    // areaRefOne.getFirstCell().getCellRefParts();
    // String[] areaOneLastCellRefParts =
    // areaRefOne.getLastCell().getCellRefParts();
    // String[] areaTwoFirstCellRefParts =
    // areaRefTwo.getFirstCell().getCellRefParts();
    // String[] areaTwoLastCellRefParts =
    // areaRefTwo.getLastCell().getCellRefParts();
    //
    //
    // }
}
