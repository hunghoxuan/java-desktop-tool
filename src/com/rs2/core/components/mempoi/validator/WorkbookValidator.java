...
public class WorkbookValidator {
     ...
     */
    public void validateWorkbookTypeOrThrow(Workbook workbook, Class<? extends Workbook> wbClazz, String error)
        ...
        if (!workbook.getClass().equals(wbClazz)) {
            throw new MempoiException(
                    !StringUtils.isEmpty(error) ? error : Errors.ERR_WORKBOOK_CLASS_NOT_CORRESPONDING);
        }
    }
}
