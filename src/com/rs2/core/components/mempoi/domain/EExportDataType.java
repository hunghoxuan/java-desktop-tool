...
public enum EExportDataType {
    ...
    /**
     * the param type to pass to the method identified by the rsAccessDataMethodName
     * property
     */
    private Class<?> rsAccessParamClass;
    /**
     * the return type class of the resultSet's method identified by the properies
     * rsAccessDataMethodName and rsAccessParamClass
     */
