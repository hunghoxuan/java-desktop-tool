package com.rs2.core.components.mempoi.manager;
...
public class FileManager {
    ...
    /**
     * write the workbook in a temporary file. in this way we can use SXSSF, apply
     * cell formulas and evaluate them. otherwise on large dataset it will fails
     * because SXSSF keep in memory only a few rows
     *
