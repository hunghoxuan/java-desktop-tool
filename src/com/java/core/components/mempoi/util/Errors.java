...
public class Errors {
        ...
        public static final String ERR_POST_DATA_ELABORATION_NULL_FORCE_GENERATION = ERR_POST_DATA_ELABORATION_NULL
                        + FORCE_GENERATION_ENABLED + "Creating new map";
        ...
        public static final String ERR_TABLE_SOURCE_AMBIGUOUS_FORCE_GENERATION = ERR_TABLE_SOURCE_AMBIGUOUS
                        + FORCE_GENERATION_ENABLED + "All sheet data takes precedence over area reference";
        public static final String ERR_TABLE_SOURCE_NOT_FOUND = "Source for table not found";
        public static final String ERR_TABLE_SOURCE_NOT_FOUND_FORCE_GENERATION = ERR_TABLE_SOURCE_AMBIGUOUS
                        + FORCE_GENERATION_ENABLED + "All sheet data will be used";
        ...
        public static final String ERR_PIVOTTABLE_SOURCE_AMBIGUOUS_FORCE_GENERATION = ERR_PIVOTTABLE_SOURCE_AMBIGUOUS
                        + FORCE_GENERATION_ENABLED + "AreaReference takes precedence over Table";
        ...
        public static final String ERR_PIVOTTABLE_SOURCE_SHEET_AMBIGUOUS_FORCE_GENERATION = ERR_PIVOTTABLE_SOURCE_SHEET_AMBIGUOUS
                        + FORCE_GENERATION_ENABLED + "Table source takes precedence over sheet";
        ...
        public static final String ERR_NEGATIVE_COL_OFFSET_FORCE_GENERATION = ERR_NEGATIVE_COL_OFFSET
                        + FORCE_GENERATION_ENABLED + "Setting to 0";
        public static final String ERR_NEGATIVE_ROW_OFFSET = "MemPOI did receive a negative row offset. Offset must be >= 0";
        public static final String ERR_NEGATIVE_ROW_OFFSET_FORCE_GENERATION = ERR_NEGATIVE_ROW_OFFSET
                        + FORCE_GENERATION_ENABLED + "Setting to 0";
