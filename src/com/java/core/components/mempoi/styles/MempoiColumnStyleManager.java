...
package com.java.core.components.mempoi.styles;

import com.java.core.components.mempoi.domain.EExportDataType;
...
public class MempoiColumnStyleManager {
    ...
    /**
     * set the CellStyle of the received MempoiColumn using the received
     * EExportDataType to identify the needed one
     * this method is used to granularly override the MempoiColumn cell style
     * starting by an EExportDataType
     *
     * @param mempoiColumn   the MempoiColumn on which set the cell style
     * @param exportDataType the EExportDataType to use to identify the required
     *                       style
     */
     ...
     * @return true if the received EExportDataType belongs to the numeric list,
     *         false otherwise
     */
