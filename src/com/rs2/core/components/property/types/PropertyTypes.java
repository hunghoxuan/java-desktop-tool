package com.rs2.core.components.property.types;
...
public final class PropertyTypes {
	public static final class ArrayType extends CollectionType<Collection<?>> {
		/**
		...
		@Override
		public Collection<?> toObject(PropertyNode propertyNode) {
