 ...
 * Those methods ask both to {@link java.core.components.mempoi.strategos.Strategos}  to coordinate the export process
 */
package com.java.core.components.mempoi;
...
import com.java.core.components.mempoi.strategos.Strategos;
...
public class MemPOI {
     ...
     * saves exported data into a File if a file path has been set using the
     * MempoiBuilder, otherwise into a byte array
     *
     * @return a CompletableFuture containing the MempoiReport object (exported data
     *         info and metadata)
     */
    ...
    /**
     * exports data into a POI report. saves exported data into the File identified
     * by the file variable
     *
     * @return a CompletableFuture containing the string of the file name (absolute
    ...
    public CompletableFuture<String> prepareMempoiReportToFile() {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                Strategos strategos = new Strategos(this.workbookConfig);
                return strategos.generateMempoiReportToFile(this.workbookConfig.getSheetList(),
                        this.workbookConfig.getFile());
            } catch (Exception e) {
                throw new MempoiException(e);
            }
        });
