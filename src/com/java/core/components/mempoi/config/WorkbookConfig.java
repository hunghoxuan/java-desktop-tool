...
public class WorkbookConfig {
    ...
    /**
     * the sub footer fallback to apply to the report. if null no sub footer is
     * appended to the report. you could also specify a particular MempoiSubFooter
     * for the singles sheets
     */
    private MempoiSubFooter mempoiSubFooter;

    /**
     * the footer fallback to apply to the report. if null no footer is appended to
     * the report. you could also specify a particular MempoiFooter for the singles
     * sheets
     */
    ...
    /**
     * if true mempoi tries to adjust all columns width accordingly with column data
     * cells length
     */
     ...
     * report
     * but if this var is true MemPOI tries to evaluate cell formulas at runtime
     * instead
     */
