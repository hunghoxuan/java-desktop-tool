...
import com.rs2.core.components.mempoi.domain.footer.MempoiSubFooterCell;
...
public class MempoiColumn {
     ...
     * If a mempoiColumnConfig is set and a display name is configured then, the
     * configured displayed name is returned.
     *
    ...
    /**
     * read result set access method String from type and set the relative
     * java.reflect.Method
     */
    ...
    public MempoiColumn setMempoiColumnConfig(MempoiColumnConfig mempoiColumnConfig,
            MempoiColumnStyleManager mempoiColumnStyleManager) {
        ...
        if (null != this.mempoiColumnConfig) {
            ...
            this.mempoiColumnConfig.getDataTransformationFunction()
                    // if user has supplied a list of transformation functions then apply
                    // configurations
                    .ifPresent(dataTransformationFunction -> {

                        // get transform method of the DataTransformationFunction selecting the one
                        // typed by the type
                        ...
                        Method functionMethod = Arrays
                                ...
                                .filter(method -> DataTransformationFunction.TRANSFORM_METHOD_NAME
