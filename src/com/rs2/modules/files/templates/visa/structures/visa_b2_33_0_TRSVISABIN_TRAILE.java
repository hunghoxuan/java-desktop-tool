...
public class visa_b2_33_0_TRSVISABIN_TRAILE extends AsciiMessage {
	...
	public char[] reserved_1; // [94] <open=suppress, name="reserved_1">;
	...
	public visa_b2_33_0_TRSVISABIN_TRAILE(int offset, String content) {
		super(offset, content);
	}

	public visa_b2_33_0_TRSVISABIN_TRAILE(String content) {
		super(content);
	}

	public visa_b2_33_0_TRSVISABIN_TRAILE() {
		super();
	}

	public visa_b2_33_0_TRSVISABIN_TRAILE(int ifReturn) {
		super(ifReturn);
	}
	...
	public String getDescription() {
		return "visa_b2_33_0_TRSVISABIN_TRAILE_ST";
	}
}