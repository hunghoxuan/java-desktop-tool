...
BEGIN
	-- Create merchant
 	T3MP_ONBOARD_MERCHANT(
		...
		p_merchant_name => '&merchant_name__ICCGROSS',
	    p_client_type => '&contract_type__002_acquirer',
		p_service_contract_id => '&service_contract_id__111',
		p_account_type_ids => '&account_type_id__012_s',
		p_service_ids => '',
		...
		p_settlement_method => '523',
		p_posting_method => '002',
		p_client_tariff => '000509',
