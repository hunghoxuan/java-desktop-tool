...
----------------------------------------------------------------
  ...
  FOR i IN 1..p_service_ids.count LOOP
	    ...
	    ('00000111',v_application_number,'20191130','pipeline Insert',p_service_contract_id,p_service_ids(i),'001','0.00','003',null,p_client_tariff,null,null,null,'0',null,null,null,null,null,null,null,null,null);
  END LOOP;
...
begin
	...
	v_client_number := '69111111';--|| substr( BW_CODE_LIBRARY.GETNEXTSEQNUMBER('010',1),-6) ; --Client ID
