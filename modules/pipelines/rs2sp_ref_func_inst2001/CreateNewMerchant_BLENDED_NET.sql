...
begin
	...
	BW_PRC_RES.INITGLOBALVARS (v_institution_number,'129','999999', v_init_return);
  	...
  	account_ids := p_type(); account_ids.extend(4);
	account_ids(1) := '007'; account_ids(2) := '012'; account_ids(3) := '015'; account_ids(4) := '009';--009 Dispute Account
	...
	v_client_tariff := '000501';--000511 = IC++ ; 000502 =	Blended Gross+Charge; --000501 = Blended NET;
