...
public class MyTabbedPane extends JTabbedPane {
    ...
    public MyTabbedPane() {
        ...
        final DragSourceListener dsl = new DragSourceListener() {
            ...
            public void dragOver(DragSourceDragEvent e) {
                 ...
                 * SwingUtilities.convertPointFromScreen(tabPt, MyTabbedPane1.this);
                 * if (MyTabbedPane1.this.contains(tabPt)) {
            ...
            public void dragGestureRecognized(DragGestureEvent e) {
                ...
                try {
                    e.startDrag(DragSource.DefaultMoveDrop,
                            new TabTransferable(MyTabbedPane.this, dragTabIndex), dsl);
        ...
        m_acceptor = new TabAcceptor() {
            public boolean isDropAcceptable(MyTabbedPane a_component, int a_index) {
                return true;
            }
        };
    }
    ...
    class TabTransferable implements Transferable {
        ...
        public TabTransferable(MyTabbedPane a_tabbedPane, int a_tabIndex) {
            m_data = new TabTransferData(MyTabbedPane.this, a_tabIndex);
        }

        public Object getTransferData(DataFlavor flavor) {
            return m_data;
            // return MyTabbedPane1.this;
        }
    ...
    class TabTransferData {
        private MyTabbedPane m_tabbedPane = null;
        private int m_tabIndex = -1;

        public TabTransferData() {
        }

        public TabTransferData(MyTabbedPane a_tabbedPane, int a_tabIndex) {
    ...
    private Point buildGhostLocation(Point a_location) {
        ...
        retval = SwingUtilities.convertPoint(MyTabbedPane.this,
                retval, s_glassPane);
        return retval;
    }
    ...
    class CDropTargetListener implements DropTargetListener {
        public void dragEnter(DropTargetDragEvent e) {
            // System.out.println("DropTarget.dragEnter: " + MyTabbedPane1.this);
        ...
        public void dragExit(DropTargetEvent e) {
            // System.out.println("DropTarget.dragExit: " + MyTabbedPane1.this);
            m_isDrawRect = false;
        }
        ...
        public void drop(DropTargetDropEvent a_event) {
            // System.out.println("DropTarget.drop: " + MyTabbedPane1.this);
        ...
        public boolean isDragAcceptable(DropTargetDragEvent e) {
            ...
            if (MyTabbedPane.this == data.getTabbedPane()
                    && data.getTabIndex() >= 0) {
                return true;
            } // if
    ...
    private void convertTab(TabTransferData a_data, int a_targetIndex) {
        MyTabbedPane source = a_data.getTabbedPane();
    ...
    public interface TabAcceptor {
        boolean isDropAcceptable(MyTabbedPane a_component, int a_index);
    }
}
