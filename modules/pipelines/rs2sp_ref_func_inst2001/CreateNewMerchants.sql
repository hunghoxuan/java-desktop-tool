...
begin
  ...
  --BLENDED NET EUR MERCHANT
   ...
   INSERT INTO CIS_APPL_TERMINAL_INPUT (APPLICATION_NUMBER,TERMINAL_ID,INSTITUTION_NUMBER,MERCHANT_ID,RECORD_DATE,TERMINAL_STATUS,SERIAL_NUMBER,TERMINAL_TYPE,CONTACT_NAME,DEVICE_CAPABILITY,LOCATION,EOD_INDICATOR,TERMINAL_CURRENCY,POS_FEE_TYPE,AUDIT_TRAIL,LOCKING_COUNTER,CONTACT_PERSON,TELEPHONE_NUMBER,TERMINAL_SERIAL_NO,TERMINAL_LOCATION,NOTE_TEXT,MANUAL_ENTRY,FOREIGN_CARD_FLAG,TMS_REFERENCE_ID,FAMS,SETTLEMENT_INDICATOR) VALUES 
    --  (v_application_number,p_Terminal_ID ,'00000111',LPAD( p_client_number, 15, '0' ),'20190110','001',NULL,NULL,'PipeLine','001',NULL,'000','978','000','19324-092127-900125-129-02160-33687','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);	                          
 	...
 	FOR i IN 1..p_address_categs.count LOOP
       ...
       ('00000111',v_application_number,p_address_categs(i),'20191130','abc1',NULL,NULL,NULL,NULL,'6000',NULL,'280','19336-142912-900133-129-00599-52152','003',NULL,NULL,NULL,'email@rs2.com',NULL,'000','20191130','000',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0',NULL,NULL,NULL);
    END LOOP;
 	
    FOR i IN 1..p_account_type_ids.count LOOP
		if (p_billing_level = '001') then
		  Insert into CIS_APPLICATION_ACCT_TYPE (INSTITUTION_NUMBER,APPLICATION_NUMBER,ACCOUNT_TYPE_ID,ACCT_CURRENCY,RECORD_TYPE,RECORD_DATE,BILLING_LEVEL,BANK_CLEARING_NUMBER,SETTLEMENT_BANK_NAME,SETTLEMENT_BANK_CITY,BANK_CONTACT_NAME,BANK_TEL_NUMBER,COUNTER_BANK_ACCOUNT,LIMIT_CURRENCY,CLIENT_LIMIT,BANK_GUARANTEE,PAYMENT_REFERENCE,AUDIT_TRAIL,CORRESP_BANK_NUMBER,CORRESP_BANK_ACCOUNT,COUNTER_BANK_ACCOUNT_NAME,STATEMENT_GENERATION,ACCT_NUMBER_RBS,ACCT_NUMBER,STATEMENT_TYPE,LIMIT_DISTRIBUTION,PARENT_LIMIT_NUMBER,LIMIT_NUMBER,SETTL_PERC_TOTAL,CASH_LIMIT,CASH_LIMIT_PERCENT,BILLING_CYCLE,LOCKING_COUNTER,RECEIVER_COUNTRY_CODE,SETTLEMENT_BANK_CITY_DR,ACCT_STARTUP_DATE,BANK_CLEARING_NUMBER_DR,BANK_CONTACT_NAME_DR,BANK_TEL_NUMBER_DR,CLEARING_ENTITY,CLEARING_ENTITY_DR,CORRESP_BANK_ACCOUNT_DR,CORRESP_BANK_NUMBER_DR,COUNTER_BANK_ACCOUNT_DR,COUNTER_BANK_ACCOUNT_NAME_DR,COUNTER_BANK_ACCOUNT_TYPE,FUNDING_NARRATIVE,FUNDING_NARRATIVE_DR,IBAN_REFERENCE,IBAN_REFERENCE_DR,PAYMENT_METHOD,PAYMENT_METHOD_DR,REUTERS_CODE,REUTERS_CODE_DR,SETTLEMENT_BANK_NAME_DR,BRANCH_REGISTRATION,BILLING_CLIENT,PAYMENT_BANK_CLIENT,LOCK_IN_FLAG,CALENDAR_DAYS_DR,CALENDAR_DAYS,COUNTER_BANK_NUMBER,FUNDING_BANK,CALENDAR_TYPE,PREPAYMENT_ID,ALLOCATION_RULE,LIMIT_OVERRIDE_PERCENT,REVIEW_PERIOD,ACCOUNT_BASE_ID,SETTLEMENT_NUMBER) 
		 VALUES ('00000111',v_application_number,p_account_type_ids(i),p_acct_currency,'003','20190110','001','00000000',null,null,null,null,'30345677',null,null,null,null,'Pipeline Insert','00000000030080508568','3007963373000000',null,null,null,null,null,null,null,null,null,null,null,'301',null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
		 	--('00000111','0000000003','012','978','003','20191003','001','DEU01110001','Non Cross Border',NULL,'Non Cross Border contact','00491629950960','DE75512108001245126199',NULL,NULL,NULL,'PR123456789','Manual- mask issue','11111222222','1231234564564253','COUNTER_BANK','001','RBS1234567894',NULL,'900',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','280',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Neu-Isenburg',NULL,NULL,NULL,NULL,NULL,NULL,'00000111',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
		 
		else
			Insert into CIS_APPLICATION_ACCT_TYPE (INSTITUTION_NUMBER,APPLICATION_NUMBER,ACCOUNT_TYPE_ID,ACCT_CURRENCY,RECORD_TYPE,RECORD_DATE,BILLING_LEVEL,BANK_CLEARING_NUMBER,SETTLEMENT_BANK_NAME,SETTLEMENT_BANK_CITY,BANK_CONTACT_NAME,BANK_TEL_NUMBER,COUNTER_BANK_ACCOUNT,LIMIT_CURRENCY,CLIENT_LIMIT,BANK_GUARANTEE,PAYMENT_REFERENCE,AUDIT_TRAIL,CORRESP_BANK_NUMBER,CORRESP_BANK_ACCOUNT,COUNTER_BANK_ACCOUNT_NAME,STATEMENT_GENERATION,ACCT_NUMBER_RBS,ACCT_NUMBER,STATEMENT_TYPE,LIMIT_DISTRIBUTION,PARENT_LIMIT_NUMBER,LIMIT_NUMBER,SETTL_PERC_TOTAL,CASH_LIMIT,CASH_LIMIT_PERCENT,BILLING_CYCLE,LOCKING_COUNTER,RECEIVER_COUNTRY_CODE,SETTLEMENT_BANK_CITY_DR,ACCT_STARTUP_DATE,BANK_CLEARING_NUMBER_DR,BANK_CONTACT_NAME_DR,BANK_TEL_NUMBER_DR,CLEARING_ENTITY,CLEARING_ENTITY_DR,CORRESP_BANK_ACCOUNT_DR,CORRESP_BANK_NUMBER_DR,COUNTER_BANK_ACCOUNT_DR,COUNTER_BANK_ACCOUNT_NAME_DR,COUNTER_BANK_ACCOUNT_TYPE,FUNDING_NARRATIVE,FUNDING_NARRATIVE_DR,IBAN_REFERENCE,IBAN_REFERENCE_DR,PAYMENT_METHOD,PAYMENT_METHOD_DR,REUTERS_CODE,REUTERS_CODE_DR,SETTLEMENT_BANK_NAME_DR,BRANCH_REGISTRATION,BILLING_CLIENT,PAYMENT_BANK_CLIENT,LOCK_IN_FLAG,CALENDAR_DAYS_DR,CALENDAR_DAYS,COUNTER_BANK_NUMBER,FUNDING_BANK,CALENDAR_TYPE,PREPAYMENT_ID,ALLOCATION_RULE,LIMIT_OVERRIDE_PERCENT,REVIEW_PERIOD,ACCOUNT_BASE_ID,SETTLEMENT_NUMBER) 
		    values ('00000111',v_application_number,p_account_type_ids(i),p_acct_currency,'003','20190110','000','00000000',null,null,null,null,null,null,null,null,null,'Pipeline Insert','00000000000000000000',null,null,null,null,null,null,null,null,null,null,null,null,'301',null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
		end if;
  END LOOP;

 --CLIENT TARRIF Blended NET (000501)
  FOR i IN 1..p_service_ids.count LOOP
	    ...
	    ('00000111',v_application_number,'20191130','19021-090443-000110-129-99999-00001',p_service_contract_id,p_service_ids(i),'001',null,'003',null,'000501',null,null,null,null,null,null,null,null,null,null,null,null,null);
  END LOOP;
  ...
  --      ('20191130','00000111',p_client_number,lpad(i, 3, '0'),'Pipeline Insert',null,p_acct_currency,'00000000030080508568','00000000',null,'3007963373000000','30345677',null,lpad(i, 2, '0'),null,'004',null,null,null,'00000000',null,null,null,'003',null,'0',null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'0','0',null,null,null);
  --END LOOP;
...
begin
	...
	v_posting_method :='001';--NET  
	v_currency :='978'; --EUR
	v_settlement_method :='010'; --010	Dly 7 NOreserve NET 
	v_BuisnessClass := '5999';
	v_condition_set:= '000011';
	v_merch_tran_tariff := '000000';

    create_merchant(v_client_number, address_categs, account_ids, sid, settlement, v_billing_level, v_service_contract_id, v_condition_set,v_merch_tran_tariff, v_settlement_method, v_posting_method, v_currency, v_BuisnessClass);
