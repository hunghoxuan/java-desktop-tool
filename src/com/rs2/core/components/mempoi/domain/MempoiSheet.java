...
public class MempoiSheet {
    ...
    /**
     * simple text header cells style that, if present, overrides the general
     * styleTemplate
     */
    ...
    /**
     * common data type cells style that, if present, overrides the general
     * styleTemplate
     */
    ...
    /**
     * floating point number cells style that, if present, overrides the general
     * styleTemplate
     */
    private CellStyle floatingPointCellStyle;
    /**
     * simple text footer cells style that, if present, overrides the general
     * styleTemplate
     */
    ...
    // TODO remove Optional from variable - they should only be returned
    /**
     * the sub footer to apply to the sheet. if null no sub footer is appended to
     * the report
     */
    ...
    // TODO remove Optional from variable - they should only be returned
    /**
     * a MempoTable containing data to build an optional Excel Table inside the
     * current sheet
     */
    ...
    // TODO remove Optional from variable - they should only be returned
    /**
     * a MempoPivotTable containing data to build an optional Excel PivotTable
    ...
    /**
     * the offset to apply to the sheet when calculating the first column (starting
     * from left) of the export
     */
    private int columnsOffset;
    /**
     * the offset to apply to the sheet when calculating the first row (starting
     * from top) of the export
     */
    private int rowsOffset;

    public MempoiSheet(List<List<String>> _data) {
        this.data = _data;
    }
    ...
    public MempoiSheet(List<List<String>> _data, String sheetName) {
        this.data = _data;
