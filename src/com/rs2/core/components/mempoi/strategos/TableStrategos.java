...
import com.rs2.core.components.mempoi.util.AreaReferenceUtils;
...
public class TableStrategos {
     ...
     * 
     * @return an Optional with the AreaReference of the table, if a table was
     *         created,
     */
    ...
    private AreaReference addTable(MempoiSheet mempoiSheet, MempoiTable mempoiTable) {
        ...
        AreaReference areaReference = this.workbookConfig.getWorkbook().getCreationHelper()
                .createAreaReference(mempoiTable.getAreaReferenceSource());
