package com.rs2.modules.cardsgen;
		...
		for (String line : cards) {
			...
			if (line.startsWith("BYTE")) {
				...
				if (line.contains("//"))
					...
					desc = "";
				content += "package com.rs2.files.visa.structures;\n\n";
				content += "import com.rs2.files.isoparser.elements.ascii.AsciiField;\n";
				content += "import com.rs2.files.isoparser.elements.ascii.AsciiMessage;\n\n";
