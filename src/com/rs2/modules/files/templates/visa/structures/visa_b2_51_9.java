...
public class visa_b2_51_9 extends AsciiMessage {
	...
	public visa_b2_51_9(int offset, String content) {
		super(offset, content);
	}

	public visa_b2_51_9(String content) {
		super(content);
	}
	...
	public visa_b2_51_9(int ifReturn) {
		super(ifReturn);
	}
	...
	public String getDescription() {
		return "TCR E - COMMERCE OVERFLOW DATA.";
	}
}