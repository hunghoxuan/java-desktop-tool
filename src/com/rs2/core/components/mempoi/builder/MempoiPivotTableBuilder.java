...
import com.rs2.core.components.mempoi.domain.pivottable.MempoiPivotTableSource;
...
import com.rs2.core.components.mempoi.validator.AreaReferenceValidator;
import com.rs2.core.components.mempoi.validator.WorkbookValidator;
...
public final class MempoiPivotTableBuilder {
     ...
     * @return this MempoiPivotTableBuilder
     */
    public MempoiPivotTableBuilder withColumnLabelColumns(
            EnumMap<DataConsolidateFunction, List<String>> columnLabelColumns) {
     ...
     * sets the columnLabelColumns of the pivot table
     *
     * @param dataConsolidateFunction the DataConsolidateFunction on which add the
     *                                table column
     * @param columnLabelColumnList   the list of column names to add to the pivot
     *                                table
     * @return this MempoiPivotTableBuilder
     */
    public MempoiPivotTableBuilder addColumnLabelColumns(DataConsolidateFunction dataConsolidateFunction,
            List<String> columnLabelColumnList) {
     ...
     * mempoiTable OR areaReference are accepted. both valued will result in
     * exception
     *
     ...
     * exception
     *
     * @param areaReference a string representing the square of AreaReference to use
     *                      as source of the pivot table.
     * @return this MempoiPivotTableBuilder
     */
    ...
    public MempoiPivotTable build() {
        ...
        return new MempoiPivotTable(
                ...
                null != this.columnLabelColumns ? this.columnLabelColumns
                        : new EnumMap<>(DataConsolidateFunction.class),
    ...
    private void validate() {
        ...
        this.workbookValidator.validateWorkbookTypeOrThrow(this.workbook, XSSFWorkbook.class,
                Errors.ERR_PIVOT_TABLE_SUPPORTS_ONLY_XSSF);
