...
class FooterStrategos {
     ...
     * @param columnList                 the list of MempoiColumn from which get
     *                                   info data
     * @param mempoiSheet                the MempoiSheet containing footer and
     ...
     * @param mempoiSheetMetadataBuilder the mempoiSheetMetadataBuilder in which
     *                                   insert metadata
     ...
     * @param mempoiSheetMetadataBuilder the mempoiSheetMetadataBuilder in which set
     *                                   metadata
