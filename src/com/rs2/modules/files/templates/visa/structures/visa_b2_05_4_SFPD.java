...
public class visa_b2_05_4_SFPD extends AsciiMessage {
	...
	public char[] payment_account_ref; // [20] <open=suppress, name="payment_account_ref">;
	public char[] token_requestor_id; // [11] <open=suppress, name="token_requestor_id">;
	public char[] reserved_3; // [17] <open=suppress, name="reserved_3">;

	public visa_b2_05_4_SFPD(int offset, String content) {
		super(offset, content);
	}

	public visa_b2_05_4_SFPD(String content) {
		super(content);
	}

	public visa_b2_05_4_SFPD() {
		super();
	}

	public visa_b2_05_4_SFPD(int ifReturn) {
		super(ifReturn);
	}
	...
	public void initFields(int ifReturn) {
		...
		addElement("payment_account_ref", 20);
		addElement("token_requestor_id", 11);
		addElement("reserved_3", 17);
