...
public final class MempoiTableBuilder {
     ...
     *
     * @param areaReferenceSource a string representing the square on which creating
     *                            the table. format example: A1:C18
     * @return this MempoiTableBuilder
     */
    ...
    /**
     * if receives true the table will be built using all current (the one
     * containing the table) sheet data
     *
    ...
    private void validate() {
        ...
        this.workbookValidator.validateWorkbookTypeOrThrow(this.workbook, XSSFWorkbook.class,
                Errors.ERR_TABLE_SUPPORTS_ONLY_XSSF);
