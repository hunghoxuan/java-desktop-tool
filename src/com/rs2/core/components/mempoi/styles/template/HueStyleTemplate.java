package com.rs2.core.components.mempoi.styles.template;

import com.rs2.core.components.mempoi.styles.StandardDataFormat;
import lombok.Data;
...
public abstract class HueStyleTemplate implements StyleTemplate {
    ...
    private short simpleTextHeaderFontSizeInPoint = 14;
    ...
    private short colsHeaderFontSizeInPoint = 14;
    ...
    private CellStyle setSimpleHeaderOrFooterCellStyle(Workbook workbook, short cellBgColorIndex, short fontColor,
            short fontSize, short borderColor) {
    ...
    public CellStyle getSubfooterCellStyle(Workbook workbook) {
        ...
        return this.setGenericCellStyle(workbook, this.subFooterCellBgColorIndex, this.subFooterFontColorIndex, true,
    ...
    public CellStyle getDateCellStyle(Workbook workbook) {
        ...
        CellStyle cellStyle = this.setGenericCellStyle(workbook, this.commonCellBgColorIndex, this.commonFontColorIndex,
                false, this.borderColorIndex);
        cellStyle.setDataFormat(workbook.getCreationHelper().createDataFormat()
                .getFormat(StandardDataFormat.STANDARD_DATE_FORMAT.getFormat()));
        return cellStyle;
    }
    ...
    public CellStyle getDatetimeCellStyle(Workbook workbook) {
        ...
        CellStyle cellStyle = this.setGenericCellStyle(workbook, this.commonCellBgColorIndex, this.commonFontColorIndex,
                false, this.borderColorIndex);
        cellStyle.setDataFormat(workbook.getCreationHelper().createDataFormat()
                .getFormat(StandardDataFormat.STANDARD_DATETIME_FORMAT.getFormat()));
        return cellStyle;
    }
    ...
    public CellStyle getIntegerCellStyle(Workbook workbook) {
        ...
        return this.setGenericCellStyle(workbook, this.commonCellBgColorIndex, this.commonFontColorIndex, false,
                this.borderColorIndex);
    }
     ...
     * @return
     */
    private CellStyle setGenericCellStyle(Workbook workbook, short cellBgColorIndex, short fontColorIndex, boolean bold,
            short borderColor) {
