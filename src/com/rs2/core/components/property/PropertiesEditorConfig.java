...
import com.rs2.core.components.property.types.PropertyTypes;
...
public class PropertiesEditorConfig {
	public static String buttonAddTitle = " + ";
	public static String buttonCloneTitle = "x2";
	public static String buttonRemoveTitle = " x ";
	...
	public static PropertiesEditorConfig defaultConfig() {
		...
		builder.addType(new PropertyTypes.ArrayType("Array"));

		builder.addDefaultType(new PropertyTypes.StringType("String", ""));
		// builder.addType(new PropertyTypes.StringType("String [1]", ""));
	...
	public PropertyType<?> getType(Class<?> javaType) {
		...
		if (javaType.getName().startsWith("["))
			return types.get(0);
		return defaultType;
	...
	public PropertyNode fromObject(String key, Object object) {
		...
		if (object.getClass().getName().startsWith("[")) {
			List<List<String>> list = new LinkedList<List<String>>();
			for (String[] strings : (String[][]) object) {
