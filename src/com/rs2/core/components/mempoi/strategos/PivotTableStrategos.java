...
public class PivotTableStrategos {
     ...
     *
     * @return an Optional with the AreaReference of the pivottable, if a pivottable
     *         was created
     */
    ...
    private AreaReference addPivotTable(MempoiSheet mempoiSheet, MempoiPivotTable mempoiPivotTable) {
        ...
        columnLabelColumns.keySet()
                .forEach(dataConsolidateFunction -> addColumnsToPivotTable(
                        columnLabelColumns.get(dataConsolidateFunction), mempoiColumnList,
                        i -> pivotTable.addColumnLabel(dataConsolidateFunction, i)));

        return pivotTable.getPivotCacheDefinition().getPivotArea(mempoiSheet.getWorkbook());
    }

    private void addColumnsToPivotTable(List<String> columnNames, List<MempoiColumn> mempoiColumnList,
            Consumer<Integer> pivotTablePopulator) {
     ...
     *
     * @param mempoiPivotTable the MempoiPivotTable containing data needed to create
     *                         the desired PivotTable
    ...
    private XSSFPivotTable createPivotTable(MempoiSheet mempoiSheet, MempoiPivotTable mempoiPivotTable) {
        ...
        return null == pivotTableSource.getMempoiSheet()
                ...
                : sheet.createPivotTable(areaReference, mempoiPivotTable.getPosition(),
                        pivotTableSource.getMempoiSheet().getSheet());
