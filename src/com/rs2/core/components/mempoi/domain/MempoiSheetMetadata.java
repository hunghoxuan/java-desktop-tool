...
package com.rs2.core.components.mempoi.domain;
...
public class MempoiSheetMetadata {
     ...
     * the count starts at row 0 and goes until the last row (included) with at
     * least one populated cell
     */
    private Integer totalRows;
    /**
     * total number of rows containing plain exported data (no pivot tables or
     * other). it coincides with resultSet size
     */
    private Integer totalDataRows;
    /**
     * index of the first row that contains plain exported data (no pivot tables or
     * other)
     */
    private Integer firstDataRow;
    /**
     * index of the last row that contains plain exported data (no pivot tables or
     * other)
     */
     ...
     * the count starts at column 0 and goes until the last column (included) with
    ...
    private Optional<AreaReference> composeAreaReference(Supplier<CellReference> firstCellRefSupplier,
            Supplier<CellReference> lastCellRefSupplier) {
     ...
     * 
     * @return the area reference corresponding to the simple text header, null if
     *         not available
     */
    public Optional<AreaReference> composeSimpleTextHeaderAreaReference() {
        return composeAreaReference(this::composeFirstSimpleTextHeaderCellReference,
                this::composeLastSimpleTextHeaderCellReference);
    }

    /**
     * compose and return the cell reference corresponding to the upper left corner
     * of containing the simple text header
     * 
     * @return the cell reference corresponding to the upper left corner of the
     *         column headers
     */
     ...
     * 
     * @return the cell reference corresponding to the bottom right corner of the
     *         simple text header
     */
    ...
    /**
     * compose and return the cell reference corresponding to the bottom right
     * corner of the column headers
     * 
     * @return the cell reference corresponding to the bottom right corner of the
     *         column headers
     */
    ...
    /**
     * compose and return the cell reference corresponding to the bottom right
     * corner of the plain exported data
     * 
     * @return the cell reference corresponding to the bottom right corner of the
     *         plain exported data
     */
     ...
     * 
     * @return the area reference corresponding to the simple text Footer, null if
     *         not available
     */
    public Optional<AreaReference> composeSimpleTextFooterAreaReference() {
        return composeAreaReference(this::composeFirstSimpleTextFooterCellReference,
                this::composeLastSimpleTextFooterCellReference);
    }

    /**
     * compose and return the cell reference corresponding to the upper left corner
     * of containing the simple text Footer
     * 
     * @return the cell reference corresponding to the upper left corner of the
     *         column Footer
     */
    ...
    /**
     * compose and return the cell reference corresponding to the upper left corner
     * of the table present in the generated report
     * 
     * @return the cell reference corresponding to the upper left corner of the
     *         table
     */
    ...
    /**
     * compose and return the cell reference corresponding to the bottom right
     * corner of the table present in the generated report
     * 
     * @return the cell reference corresponding to the bottom right corner of the
     *         table
     */
    ...
    /**
     * compose and return the area reference containing the table present in the
     * generated report
     * 
    ...
    /**
     * compose and return the cell reference corresponding to the upper left corner
     * of the pivot table present in the generated report
     * 
     * @return the cell reference corresponding to the upper left corner of the
     *         pivot table
     */
    ...
    /**
     * compose and return the cell reference corresponding to the bottom right
     * corner of the pivot table present in the generated report
     * 
     * @return the cell reference corresponding to the bottom right corner of the
     *         pivot table
     */
    ...
    /**
     * compose and return the area reference containing the source of the pivot
     * table present in the generated report
     * 
    ...
    public Optional<AreaReference> composePivotTableSourceAreaReference() {
        return composeAreaReference(this::composeFirstPivotTableSourceCellReference,
                this::composeLastPivotTableSourceCellReference);
    }
}
