procedure bw_launch_029_process(
...
begin
  ...
  --
  v_params := BW_PROCESS_CONTROL.GET_PROCESS_PARAM_STRING_LIST(p_instno, '029', v_postdate);
  --
  if v_params != '[# NO DATA FOUND! #]' then
    --
    bw_process_control.run_process(
        p_InstitutionNumber_IN  => p_instno,
        p_ProcessName_IN        => '029',
