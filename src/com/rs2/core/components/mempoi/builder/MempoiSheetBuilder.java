...
import com.rs2.core.components.mempoi.datapostelaboration.mempoicolumn.MempoiColumnElaborationStep;
import com.rs2.core.components.mempoi.domain.MempoiColumnConfig;
import com.rs2.core.components.mempoi.domain.MempoiSheet;
import com.rs2.core.components.mempoi.domain.MempoiTable;
import com.rs2.core.components.mempoi.domain.footer.MempoiFooter;
import com.rs2.core.components.mempoi.domain.footer.MempoiSubFooter;
import com.rs2.core.components.mempoi.domain.pivottable.MempoiPivotTable;
...
import com.rs2.core.components.mempoi.util.Errors;
import com.rs2.core.components.mempoi.util.ForceGenerationHelper;
...
public final class MempoiSheetBuilder {
    ...
    /**
     * maps a column name to a desired implementation of MempoiColumnElaborationStep
     * interface it defines the post data
    ...
    /**
     * add the received Workbook to the builder instance. it is needed for passing
     * StyleTemplate
     *
    ...
    /**
     * add the received StyleTemplate to the builder instance. you need to pass a
     * Workbook to use this StyleTemplate
     *
     ...
     * add the received text as simple sheet header
     *
     * @param simpleTextHeaderCellStyle the CellStyle to use as simple text header
     *                                  cell's styler
     * @return the current MempoiSheetBuilder
     */
    ...
    /**
     * add the received CellStyle as common data cell's styler to the builder
     * instance
     *
    ...
    /**
     * add the received CellStyle as floating point cell's styler to the builder
     * instance
     *
     * @param floatingPointCellStyle the CellStyle to use as floating point cell's
     *                               styler
     * @return the current MempoiSheetBuilder
     */
     ...
     * add the received text as simple sheet header
     *
     * @param simpleTextFooterCellStyle the CellStyle to use as simple text footer
     *                                  cell's styler
     * @return the current MempoiSheetBuilder
     */
     ...
     * @return the current MempoiSheetBuilder
     */
    public MempoiSheetBuilder withData(List<List<String>> data) {
        this.data = data;
        return this;
    }

    /**
     * add the received String array to the builder instance as array of column
     * names to be merged
     * the merge is made merging adiacent cells with the same value in the same
     * column
     *
     * @param mergedRegionColumns the String array of the column's names to be
     *                            merged
     * @return the current MempoiSheetBuilder
     */
    ...
    /**
     * add the received map of column name - DataPostElaborationStep to the builder
     * and then to the mempoisheet
     * 
     * @param dataElaborationStepMap map of the DataElaborationStep (column name,
     *                               step to process)
     *
     * @return the current MempoiSheetBuilder
     */
    public MempoiSheetBuilder withDataElaborationStepMap(
            Map<String, List<MempoiColumnElaborationStep>> dataElaborationStepMap) {
    ...
    /**
     * adds a MempoiTable object containing data to build an optional Excel Table
     * inside the current sheet
     *
     * @param mempoiTable the MempoiTable containing data to generate the desired
     *                    Excel table
     * @return the current MempoiSheetBuilder
     */
    ...
    /**
     * adds a MempoiTableBuilder object containing data to build an optional Excel
     * Table inside the current sheet
     *
     * @param mempoiTableBuilder the MempoiTableBuilder containing data to generate
     *                           the desired Excel table
     * @return the current MempoiSheetBuilder
     */
    ...
    /**
     * adds a MempoiPivotTable object containing data to build an optional Excel
     * PivotTable inside the current sheet
     *
     * @param mempoiPivotTable the MempoiPivotTable containing data to generate the
     *                         desired Excel Pivot table
     * @return the current MempoiSheetBuilder
     */
    ...
    /**
     * adds a MempoiPivotTableBuilder object containing data to build an optional
     * Excel PivotTable inside the current sheet
     *
     * @param mempoiPivotTableBuilder the MempoiPivotTableBuilder containing data to
     *                                generate the desired Excel Pivot table
     * @return the current MempoiSheetBuilder
     */
     ...
     *
     * @param mempoiColumnConfigList the list of MempoiColumnConfig to set to the
     *                               relative MempoiColumns
     * @return the current MempoiSheetBuilder
     */
     ...
     *
     * @param mempoiColumnConfig the MempoiColumnConfig to add to the list of
     *                           mempoiColumnConfig
     * @return the current MempoiSheetBuilder
     */
    ...
    public MempoiSheet build() {
        ...
        if (prepStmt != null)
            mempoiSheet = new MempoiSheet(prepStmt);
        else if (data != null)
            mempoiSheet = new MempoiSheet(this.data);

        if (null == mempoiSheet) {
            throw new MempoiException("PreparedStatement null for MempoiSheet "
                    + (!StringUtils.isEmpty(sheetName) ? " with name " + sheetName : ""));
        }
