...
public class visa_b2_32_0_DE extends AsciiMessage {
	...
	public char[] merchant_street_address; // [40] <open=suppress, name="merchant_street_address">;
	public char[] reserved_5; // [20] <open=suppress, name="reserved_5">;
	...
	public visa_b2_32_0_DE(int offset, String content) {
		super(offset, content);
	}

	public visa_b2_32_0_DE(String content) {
		super(content);
	}

	public visa_b2_32_0_DE() {
		super();
	}

	public visa_b2_32_0_DE(int ifReturn) {
		super(ifReturn);
	}
	...
	public void initFields(int ifReturn) {
		...
		addElement("merchant_street_address", 40);
		addElement("reserved_5", 20);
	...
	public String getDescription() {
		return "TCR0 - DE -Additional Data";
	}
}