...
public class visa_b2_50 extends AsciiMessage {
	...
	public char[] message_text; // [164] <open=suppress, name="message_text">;

	public visa_b2_50(int offset, String content) {
		super(offset, content);
	}

	public visa_b2_50(String content) {
		super(content);
	}
	...
	public visa_b2_50(int ifReturn) {
		super(ifReturn);
	}
