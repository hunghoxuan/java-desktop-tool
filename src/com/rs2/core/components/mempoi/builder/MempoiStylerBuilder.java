package com.rs2.core.components.mempoi.builder;

import com.rs2.core.components.mempoi.styles.MempoiStyler;
import com.rs2.core.components.mempoi.styles.template.StandardStyleTemplate;
import com.rs2.core.components.mempoi.styles.template.StyleTemplate;
...
public class MempoiStylerBuilder {
    ...
    /**
     * private constructor to lower constructor visibility from outside forcing the
     * use of the static Builder pattern
     */
    ...
    /**
     * static method to create a new MempoiStylerBuilder containing the received
     * Workbook
     *
    ...
    /**
     * add the received CellStyle as simple text HeaderCell styler to the builder
     * instance
     *
     * @param simpleTextHeaderCellStyle the CellStyle to set as simple text
     *                                  HeaderCell styler
     * @return the current MempoiStylerBuilder
     */
    public MempoiStylerBuilder withSimpleTextHeaderCellStyle(CellStyle simpleTextHeaderCellStyle) {
        this.simpleTextHeaderCellStyle = null != simpleTextHeaderCellStyle ? simpleTextHeaderCellStyle
                : this.styleTemplate.getSimpleTextHeaderCellStyle(this.workbook);
        return this;
    }

    /**
     * add the received CellStyle as simple text FooterCell styler to the builder
     * instance
     *
     * @param simpleTextFooterCellStyle the CellStyle to set as simple text
     *                                  FooterCell styler
     * @return the current MempoiStylerBuilder
     */
    public MempoiStylerBuilder withSimpleTextFooterCellStyle(CellStyle simpleTextFooterCellStyle) {
        this.simpleTextFooterCellStyle = null != simpleTextFooterCellStyle ? simpleTextFooterCellStyle
                : this.styleTemplate.getSimpleTextFooterCellStyle(this.workbook);
        return this;
    }
    ...
    public MempoiStylerBuilder withColsHeaderCellStyle(CellStyle colsHeaderCellStyle) {
        this.colsHeaderCellStyle = null != colsHeaderCellStyle ? colsHeaderCellStyle
                : this.styleTemplate.getColsHeaderCellStyle(this.workbook);
        return this;
    }
    ...
    public MempoiStylerBuilder withSubFooterCellStyle(CellStyle subFooterCellStyle) {
        this.subFooterCellStyle = null != subFooterCellStyle ? subFooterCellStyle
                : this.styleTemplate.getSubfooterCellStyle(this.workbook);
        return this;
    }
    ...
    public MempoiStylerBuilder withCommonDataCellStyle(CellStyle commonDataCellStyle) {
        this.commonDataCellStyle = null != commonDataCellStyle ? commonDataCellStyle
                : this.styleTemplate.getCommonDataCellStyle(this.workbook);
        return this;
    }
    ...
    public MempoiStylerBuilder withDatetimeCellStyle(CellStyle datetimeCellStyle) {
        this.datetimeCellStyle = null != datetimeCellStyle ? datetimeCellStyle
                : this.styleTemplate.getDatetimeCellStyle(this.workbook);
        return this;
    }
    ...
    public MempoiStylerBuilder withIntegerCellStyle(CellStyle integerCellStyle) {
        this.integerCellStyle = null != integerCellStyle ? integerCellStyle
                : this.styleTemplate.getIntegerCellStyle(this.workbook);
        return this;
    }

    /**
     * add the received CellStyle as FloatingPointCell styler to the builder
     * instance
     *
     * @param floatingPointCellStyle the CellStyle to set as FloatingPointCell
     *                               styler
     * @return the current MempoiStylerBuilder
     */
    public MempoiStylerBuilder withFloatingPointCellStyle(CellStyle floatingPointCellStyle) {
        this.floatingPointCellStyle = null != floatingPointCellStyle ? floatingPointCellStyle
                : this.styleTemplate.getFloatingPointCellStyle(this.workbook);
        return this;
    }
    ...
    public Optional<MempoiStyler> build() {
        ...
        // customize styles
        styler.setSimpleTextHeaderCellStyle(Optional.ofNullable(this.simpleTextHeaderCellStyle)
                .orElseGet(() -> this.styleTemplate.getSimpleTextHeaderCellStyle(this.workbook)));
        styler.setSimpleTextFooterCellStyle(Optional.ofNullable(this.simpleTextFooterCellStyle)
                .orElseGet(() -> this.styleTemplate.getSimpleTextFooterCellStyle(this.workbook)));
        styler.setColsHeaderCellStyle(Optional.ofNullable(this.colsHeaderCellStyle)
                .orElseGet(() -> this.styleTemplate.getColsHeaderCellStyle(this.workbook)));
        styler.setDateCellStyle(Optional.ofNullable(this.dateCellStyle)
                .orElseGet(() -> this.styleTemplate.getDateCellStyle(this.workbook)));
        styler.setDatetimeCellStyle(Optional.ofNullable(this.datetimeCellStyle)
                .orElseGet(() -> this.styleTemplate.getDatetimeCellStyle(this.workbook)));
        styler.setIntegerCellStyle(Optional.ofNullable(this.integerCellStyle)
                .orElseGet(() -> this.styleTemplate.getIntegerCellStyle(this.workbook)));
        styler.setFloatingPointCellStyle(Optional.ofNullable(this.floatingPointCellStyle)
                .orElseGet(() -> this.styleTemplate.getFloatingPointCellStyle(this.workbook)));
        styler.setCommonDataCellStyle(Optional.ofNullable(this.commonDataCellStyle)
                .orElseGet(() -> this.styleTemplate.getCommonDataCellStyle(this.workbook)));
        styler.setSubFooterCellStyle(Optional.ofNullable(this.subFooterCellStyle)
                .orElseGet(() -> this.styleTemplate.getSubfooterCellStyle(this.workbook)));
